...
angular.module('gettext').factory('gettextCatalog', ["gettextPlurals", "$http", "$cacheFactory", "$interpolate", "$rootScope", function (gettextPlurals, $http, $cacheFactory, $interpolate, $rootScope) {
    ...
    catalog = {
        ...
        getStringFormLang: function (lang, string, n, context) {
        ...
        getStringLang: function (lang, string, scope, context) {
            string = this.getStringFormLang(lang,string, 0, context) || prefixDebug(string);
            string = scope ? $interpolate(string)(scope) : string;
            return addTranslatedMarkers(string);
        },
        
        
        getStringLangExist: function (lang, string, scope, context) {
            string = this.getStringFormLang(lang,string, 0, context);
